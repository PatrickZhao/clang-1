...
/**
 * \defgroup CINDEX Source code parsing and AST analysis
 * \ingroup CLANGC
 *
 * This module provides a relatively small API that exposes facilities for
 * parsing source code into an abstract syntax tree (AST), loading
 ...
 */
CLANGC_LINKAGE CXSourceLocation clang_getLocation(CXTranslationUnit tu,
                                                  CXFile file,
                                                  unsigned line,
                                                  unsigned column);
/**
 ...
 * in a particular translation unit.
 */
CLANGC_LINKAGE CXSourceLocation clang_getLocationForOffset(CXTranslationUnit tu,
                                                           CXFile file,
                                                           unsigned offset);
